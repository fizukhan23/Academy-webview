...
<body class="h-100">
    <div class="authincation h-100">
                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                ...
                                <form action="{{url('/savebanners')}}" method="post" enctype="multipart/form-data">
        ...
        @endif
        @csrf   
           <h3 style="color: #8f0acd;font-weight: bold;text-align: center;font-size: 29px;">Add Banner</h3>  
          <div class="mb-3 col-md-8">
                  ...
                  <div class="mb-3 col-md-8">
                       ...
                       <div class="mb-3 col-md-8">
                        <b><label>Link</label></b>
                            <input type="link" class="form-control" name="link2" >
                            </div>
                      ...
                      <div class="mb-3 col-md-8">
                        <b><label>Link</label></b>
                            <input type="link" class="form-control" name="link3" >
                            </div>
                     </div>  
