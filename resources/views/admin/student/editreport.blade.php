...
<body class="h-100">
    <div class="authincation h-100">
                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                ...
                                <form action="{{url('/updatereport',$data->id)}}" method="post" enctype="multipart/form-data">
        ...
        @csrf   
        @Method('PUT')
           <h3 style="color: #8f0acd;font-weight: bold;text-align: center;font-size: 29px;">Edit Progress report</h3>  
       
                    <div class="mb-3 col-md-8">
                        <label>ID</label>
                            <input type="text" class="form-control" name="student_id" value="@if (!empty($data)){{ $data->student_id }}@else{{ old('student_id') }}@endif" required>
                            </div>  
                         <div class="mb-3 col-md-8">
                        <label>Skill</label>
                            <input type="date" class="form-control" name="skill" value="@if (!empty($data)){{ $data->skill }}@else{{ old('skill') }}@endif" required>
                            </div>  
                         <div class="mb-3 col-md-8">
