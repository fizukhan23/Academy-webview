            ...
            <tr>
               <td> {{ $i }}</td>
                                            ...
                                            <div class="media me-2">
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="{{url('editcategory',$u->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
														<a href="{{url('deletecategory',$u->id)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fas fa-trash"></i></a>
													</div>												
												</td>							
</tr>
<?php $i++; ?>
