                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Main Banner List</h4>
                            </div>
            ...
            <tr>
               <td> {{ $i }}</td>
                                            ...
                                            <div class="media me-2">
                                                  ...
                                                  <source src="{{asset('images/bannervideo/'.$u->video)}}" type="video/mp4">
                                           </video> 
                                                </td>
                                                <td>
                                                        <img src="{{asset('images/bannerimg/'.$u->images)}}" width="60" height="70" style="border-radius: 50%;">  
                                                </td>
                                                      </div>
                                                <td>
													<div class="d-flex">
														<a href="{{url('editmainbanner',$u->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
														<a href="{{url('deletemainbanner',$u->id)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fas fa-trash"></i></a>
													</div>												
												</td>							
</tr>
<?php $i++; ?>
