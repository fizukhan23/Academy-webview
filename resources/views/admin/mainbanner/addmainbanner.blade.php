...
<body class="h-100">
    <div class="authincation h-100">
                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                ...
                                <form action="{{url('/savemainbanner')}}" method="post" enctype="multipart/form-data">
        ...
        @endif
        @csrf   
           <h3 style="color: #8f0acd;font-weight: bold;text-align: center;font-size: 29px;">Add Main Banner</h3>  
