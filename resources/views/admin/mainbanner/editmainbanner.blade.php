...
<body class="h-100">
    <div class="authincation h-100">
                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                ...
                                <form action="{{url('/updatemainbanner',$data->id)}}" method="post" enctype="multipart/form-data">
        ...
        @csrf  
        @Method('PUT')
           <h3 style="color: #8f0acd;font-weight: bold;text-align: center;font-size: 29px;">Edit Main Banner</h3>  
       
                       <div class="mb-3 col-md-8">
                       <b> <label>Image</label></b>
                            <input type="file" class="form-control" name="images" >
                            @if(!empty($data->images))
                            <img src="{{asset('images/bannerimg/'.$data->images) }}" width="80" height="80" style="border-radius: 50%;"></td>
                                                                @endif
                            </div>  
                        <div class="mb-3 col-md-8">
                        <b><label>Video</label></b>
                            <input type="file" class="form-control" name="video" style="height:30px; weight:20px;">
                             ...
                             <video width="100" height="140"  controls>
                                                  <source src="{{asset('images/bannervideo/'.$data->video)}}" type="video/mp4">
                                           </video>   @endif
                            </div>  
                    </div>  
