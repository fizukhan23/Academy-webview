                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                ...
                                <form action="{{url('/updatesubcategory',$data->id)}}" method="post" enctype="multipart/form-data">
          ...
          @method('PUT')  
           <h3 style="color: #8f0acd;font-weight: bold;text-align: center;font-size: 29px;">Add subcategory</h3>  
                        ...
                        <label>subcategory</label>
                            <input type="text" class="form-control" name="subcategory" value="@if (!empty($data)){{ $data->subcategory }}@else{{ old('subcategory') }}@endif" >
                            </div>  
                     </div>  
