                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Combine  List</h4>
                            </div>
               ...
               <td> {{ $i }}</td>
                                            ...
                                            <div class="media me-2">
                                              <td>{{ $u->option }}</td>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="{{url('editcombine',$u->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
														<a href="{{url('deletecombine',$u->id)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fas fa-trash"></i></a>
													</div>												
												</td>							
</tr>
<?php $i++; ?>
