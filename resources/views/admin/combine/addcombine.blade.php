                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                ...
                                <form action="{{url('/savecombine')}}" method="post" enctype="multipart/form-data">
           ...
           <h3 style="color: #8f0acd;font-weight: bold;text-align: center;font-size: 29px;">Add both</h3>  
            ...
            <div class="mb-3 col-md-8">
                       <b><label>Select Option</label></b><br>
                              <input type="radio" name="option"  value="Return Policy" required>Return Policy
                                <input type="radio" name="option"  value="Term and Condition" required>Term and Condition
                                <input type="radio" name="option"  value="Shipping" required>Shipping
                                <input type="radio" name="option"  value="Course Guidline" required>Course Guidline
                                <input type="radio" name="option"  value="How to go about" required>How to go about
                              </div>
                           <div class="mb-3 col-md-8">
