               ...
               <td> {{ $i }}</td>
                                            ...
                                            <div class="media me-2">
                                               ...
                                               <td>{{ $u->mobile }}</td>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="{{url('edittrainner',$u->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
														<a href="{{url('deletetrainner',$u->id)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fas fa-trash"></i></a>
														<a href="{{url('listcoach',$u->id)}}" class="btn btn-primary mb1 bg-maroon">workshop</a>
