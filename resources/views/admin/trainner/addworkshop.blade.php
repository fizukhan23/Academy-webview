               ...
               <td> {{ $i }}</td>
                                            ...
                                            <div class="media me-2">
                                               ...
                                               <td>{{ $u->duration }}</td>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="{{url('editworkshop',$u->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
														<a href="{{url('deletetrainner',$u->id)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fas fa-trash"></i></a>
													</div>												
												</td>							
</tr>
<?php $i++; ?>
        @endforeach
                     ...
                     <div class="start-btn">
<button type="button" class="btn btn-primary" style="padding: 8px 16px;  min-width: 100px;">Add Workshop</button>
 ...
 <form name="form" action="{{url('/saveworkshop')}}" method="post" enctype="multipart/form-data">
        ...
        @csrf  
                              <div class="form_wrap">
                                  <div class="form_item">
                                      <label>ID</label>
                                      <input type="text" name="coach_id" required>
